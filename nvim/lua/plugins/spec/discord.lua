...
return {
  {
    ...
    opts = {
      ...
      blacklist = { "portfolio" }, -- A list of strings or Lua patterns that disable Rich Presence if the current file name, path, or workspace matches
      ...
      file_explorer_text = "netrw", -- Format string rendered when browsing a file explorer (either string or function(file_explorer_name: string): string)
      ...
      plugin_manager_text = "lazy", -- Format string rendered when managing plugins (either string or function(plugin_manager_name: string): string)
      ...
      terminal_text = "zshin'", -- Format string rendered when in terminal mode.
    },
  },
}
